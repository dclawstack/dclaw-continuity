...
**DClaw Continuity** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8062` (FastAPI)
- **Frontend Port:** `3062` (Next.js)
- **Database:** `dclaw_continuity` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3062`
