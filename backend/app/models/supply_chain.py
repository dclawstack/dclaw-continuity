...
class Supplier(Base, TimestampMixin):
    ...
    disruption_probability: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class SupplyChainAssessment(Base, TimestampMixin):
    ...
    suggested_alternatives: Mapped[list] = mapped_column(JSONB, default=list, nullable=False)
